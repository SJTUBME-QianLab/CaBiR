...
class CollectVariables:
    def __init__(self):
        ...
        self.npy_list = [kk.split('.nii')[0] for kk in os.listdir(
            '/home/data2/tangxl/MRIProcess/AIBL/nc_fast_final')]
    ...
    def main(self):
        ...
        dataAdd.rename(columns={'RID': 'NACCID'}, inplace=True)
        dataAdd.rename(columns={'SITEID': 'NACCADC'}, inplace=True)
